...
export const RANKS: Rank[] = [
  ...
  { type: 'Rank', name: 'Legend', price: 20, features: ['All Champion Perks', '10x Player Homes', 'Access to /kit legend', 'Custom Nickname'], imageUrl: 'https://img.icons8.com/plasticine/100/crown.png' },
];
...
export const COINS: CoinPackage[] = [
  ...
  { type: 'Coin', name: '250 Coins', amount: 250, price: 5, bonus: 'Best Value', imageUrl: 'https://img.icons8.com/plasticine/100/stack-of-coins.png' },
];