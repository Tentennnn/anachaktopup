...
interface HeaderProps {
  setCurrentPage: (page: 'home' | 'store') => void;
...
const Header: React.FC<HeaderProps> = ({ setCurrentPage, currentPage }) => {
  ...
  const NavLink: React.FC<{ page: 'home' | 'store', children: React.ReactNode }> = ({ page, children }) => {
      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h1 className="text-2xl font-bold font-pixel text-white tracking-wider">ANACHAK-MC</h1>
            </div>
          </div>
